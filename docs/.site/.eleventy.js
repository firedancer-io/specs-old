...
module.exports = function (eleventyConfig) {
  ...
  const markdownLibrary = markdownIt({
    ...
    .use(
      markdownItContainer,
      "opcode_table",
      markdownItContainerAddClass("opcode_table")
    )
    .use(
      markdownItContainer,
      "opcode_listing",
      markdownItContainerAddClass("opcode_listing")
    )
    .use(
      markdownItContainer,
      "syscall_listing",
      markdownItContainerAddClass("syscall_listing")
    )
  ...
  eleventyConfig.addPassthroughCopy(
    "../!(_legacy|.site|node_modules)/**/*.png"
  );
  //  And json files, which appear in fixtures and specs as reference.
